...
env='prod'
url_dict={
    'General Text Suggestions':"http://10.185.56.168:8051/intellitext_general",
    'Clinical Text Suggestions':"http://10.185.56.168:8051/intellitext_abstracts"
}
...
def render_home(request):
    return render(request, 'ui_attrition_prediction.html', {})
